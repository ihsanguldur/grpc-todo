...
func (c *todoServiceClient) List(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListResponse, error) {
...
func (UnimplementedTodoServiceServer) List(context.Context, *Empty) (*ListResponse, error) {
